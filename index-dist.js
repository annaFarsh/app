...
var searchFound = document.querySelector(".search__found"); //в этот список будут генерироваться элементы после поиска
//на него же я вешаю обработчик события клика, буду добавлять  по клику реппозиторий в список добавленных репозиториев
var addRepository = document.querySelector(".add__list"); //список добавленных репозиториев
...
var searchValue = document.querySelector(".search__input");
function checkValue() {
...
function _searchRepository() {
  _searchRepository = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(searchName) {
    var response, result, arraySearchedNames, listElem, _iterator, _step, obj;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.next = 2;
            return fetch("https://api.github.com/search/repositories?q=" + searchName + "&per_page=5", {});
          case 2:
          ...
          case 5:
            ...
            arraySearchedNames = result.items;
            listElem = "";
            if (arraySearchedNames.length > 1) {
              _iterator = _createForOfIteratorHelper(arraySearchedNames);
              try {
                for (_iterator.s(); !(_step = _iterator.n()).done;) {
                  obj = _step.value;
                  listElem += "<li><span class=\"name\">Name: </span>".concat(obj.name, "<div class = \"owner\">Owner: ").concat(obj.owner.login, "</div><div class = \"stars\">Stars: ").concat(obj['stargazers_count'], "</div><div class=\"button\"></div></li>");
                }
              } catch (err) {
                _iterator.e(err);
              } finally {
